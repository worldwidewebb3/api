...
export const SessionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        sessionsAppGetGameModeScoresAll: async (appId: string, appModeId: string, numberOfScores?: number, golf?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appId' is not null or undefined
...
export const SessionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async sessionsAppGetGameModeScoresAll(appId: string, appModeId: string, numberOfScores?: number, golf?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<any>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.sessionsAppGetGameModeScoresAll(appId, appModeId, numberOfScores, golf, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const SessionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        sessionsAppGetGameModeScoresAll(appId: string, appModeId: string, numberOfScores?: number, golf?: boolean, options?: any): AxiosPromise<Array<any>> {
            return localVarFp.sessionsAppGetGameModeScoresAll(appId, appModeId, numberOfScores, golf, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} appId 
...
export class SessionApi extends BaseAPI {
     ...
     * @memberof SessionApi
     */
    public sessionsAppGetGameModeScoresAll(appId: string, appModeId: string, numberOfScores?: number, golf?: boolean, options?: AxiosRequestConfig) {
        return SessionApiFp(this.configuration).sessionsAppGetGameModeScoresAll(appId, appModeId, numberOfScores, golf, options).then((request) => request(this.axios, this.basePath));
    }
