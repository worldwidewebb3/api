 ...
 * 
 * @export
 * @interface AnonymousSchema46
 */
export interface AnonymousSchema46 {
}
/**
 * 
 * @export
...
export interface NftAvatar {
    ...
    /**
     * 
     * @type {AnonymousSchema46}
     * @memberof NftAvatar
     */
    'metadata'?: AnonymousSchema46;
    /**
     * 
     * @type {number}
     * @memberof NftAvatar
...
export const SessionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        sessionsGetMembers: async (sessionId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sessionId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        sessionsGetSession: async (sessionId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sessionId' is not null or undefined
            assertParamExists('sessionsGetSession', 'sessionId', sessionId)
            const localVarPath = `/sessions/sessions/{sessionId}`
                .replace(`{${"sessionId"}}`, encodeURIComponent(String(sessionId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const SessionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async sessionsAppCloseSession(sessionId: string, appId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Session>> {
         ...
         * @throws {RequiredError}
         */
        async sessionsAppGetSession(sessionId: string, appid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Session>> {
         ...
         * @throws {RequiredError}
         */
        async sessionsAppGetSessions(appId: string, appModeId: string, allowClosed?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Session>>> {
         ...
         * @throws {RequiredError}
         */
        async sessionsGetMembers(sessionId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SessionMemberWithAvatar>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.sessionsGetMembers(sessionId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async sessionsGetSession(sessionId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Session>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.sessionsGetSession(sessionId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const SessionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        sessionsAppCloseSession(sessionId: string, appId: string, options?: any): AxiosPromise<Session> {
         ...
         * @throws {RequiredError}
         */
        sessionsAppGetSession(sessionId: string, appid: string, options?: any): AxiosPromise<Session> {
         ...
         * @throws {RequiredError}
         */
        sessionsAppGetSessions(appId: string, appModeId: string, allowClosed?: boolean, options?: any): AxiosPromise<Array<Session>> {
         ...
         * @throws {RequiredError}
         */
        sessionsGetMembers(sessionId: string, options?: any): AxiosPromise<Array<SessionMemberWithAvatar>> {
            return localVarFp.sessionsGetMembers(sessionId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} sessionId 
         ...
         * @throws {RequiredError}
         */
        sessionsGetSession(sessionId: string, options?: any): AxiosPromise<Session> {
            return localVarFp.sessionsGetSession(sessionId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SessionApi extends BaseAPI {
     ...
     * @memberof SessionApi
     */
    public sessionsGetMembers(sessionId: string, options?: AxiosRequestConfig) {
        return SessionApiFp(this.configuration).sessionsGetMembers(sessionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SessionApi
     */
    public sessionsGetSession(sessionId: string, options?: AxiosRequestConfig) {
        return SessionApiFp(this.configuration).sessionsGetSession(sessionId, options).then((request) => request(this.axios, this.basePath));
    }
}
